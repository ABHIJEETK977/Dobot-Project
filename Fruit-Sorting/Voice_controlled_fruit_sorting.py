...
1) Activate the venv that contains Hailo + OpenCV + Vosk dependencies:
   source /home/dobotproject/Robot-Manipulation/Dobot-Project/Fruit-Sorting/hailo-apps/venv_hailo_apps/bin/activate
...
drop_positions = {
    "red apple":   (123.0,  -237.6*Right,  Z_DROP_DEFAULT),
    "green apple": ( 63.0,  -234.1*Right,  Z_DROP_DEFAULT),
    "pumpkin":     (  5.6,  -228.9*Right,  Z_DROP_DEFAULT),
    "red grape":   ( -0.2,  -288.1*Right,  Z_DROP_DEFAULT),
    "black grape": ( 56.5,  -296.8*Right,  Z_DROP_DEFAULT),
    "olive":       (114.8,  -301.3*Right,  Z_DROP_DEFAULT),
    "strawberry":  (112.9,  -347.4*Right,  Z_DROP_DEFAULT),
    "pomegranate": ( 53.2,  -352.8*Right,  Z_DROP_DEFAULT),
    "carrot":      (  4.2,  -351.1*Right,  Z_DROP_DEFAULT),
}
        ...
        try:
            ...
            with self.robot_lock:
                ...
                if use_tray:
                    ...
                    tray_approach = ( 91.2, -239.5*Right, 77.9)
